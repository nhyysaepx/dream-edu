  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="text-center mb-12">
        <h1 className="font-display-lg text-primary mb-4 text-gradient">Review Unit 1-2-3-4</h1>
        <p className="font-body-lg text-on-surface-variant max-w-2xl mx-auto">
          Hoàn thành tất cả các bài tập dưới đây để ôn tập lại kiến thức nhé!
        </p>
      </div>
...
export default DEBeginnerReview;
