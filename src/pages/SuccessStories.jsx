  ...
  const testimonials = [
    {
      ...
      placement: "Oxford University '24",
      rating: 5,
      comment: '"The IELTS Academic track was a game changer. I started with a 6.0 and needed a 7.5 for my Oxford application. The tutors didn\'t just teach the test; they taught me how to communicate at an elite level."',
      score: 'IELTS 8.0',
      increase: '+2.0 Increase',
    ...
    },
    {
      id: 2,
      name: 'Jin-Woo Park',
      placement: "University of Toronto '23",
      rating: 5,
      comment: '"The personalized feedback on my writing tasks was what made the difference. Dream Education\'s portal is miles ahead of any other platform I\'ve used. I reached my goal in just 8 weeks."',
      score: 'IELTS 7.5',
    ...
    },
    {
      id: 3,
      name: 'Amina Al-Farsi',
      placement: 'LSE Graduate School',
      rating: 5,
      comment: '"Coming from a non-English background, I was terrified of the speaking section. My mentor provided a safe space to fail and improve. Now, I\'m thriving in London."',
      score: 'IELTS 8.5',
      increase: '+2.5 Increase',
    ...
    <div className="pt-20">
      ...
      <section className="relative py-16 md:py-20 px-margin-mobile overflow-hidden text-left">
        <div className="max-w-container-max mx-auto relative z-10 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-block bg-secondary-container text-on-secondary-container px-4 py-1 rounded-full font-label-md text-label-md mb-6 font-semibold border border-secondary/20">
              PROVEN RESULTS
            </span>
            <h1 className="font-display-lg text-display-lg md:text-display-lg text-primary mb-6 leading-tight font-bold">
              Your International Future, <span className="text-secondary">Secured.</span>
            </h1>
            <p className="font-body-lg text-body-lg text-on-surface-variant mb-8 max-w-lg">
              Join the thousands of students who achieved their target IELTS scores and secured placements in top global universities through our elite curriculum.
            </p>
            <div className="flex flex-wrap gap-6">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>verified</span>
                <span className="font-label-lg text-label-lg font-bold">95% Success Rate</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                <span className="font-label-lg text-label-lg font-bold">4.9/5 Student Rating</span>
              </div>
            </div>
          </div>
          <div className="relative w-full">
            <div className="aspect-square rounded-3xl overflow-hidden card-shadow border-4 border-white">
              <img
                ...
                alt="Confident successful student"
              />
            </div>
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl card-shadow animate-float border border-outline-variant/20">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="font-label-md text-label-md text-on-surface-variant">Average Improvement</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-container-max mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="md:col-span-2 bg-primary p-10 rounded-[2rem] text-on-primary flex flex-col justify-between shadow-md">
              <div>
                <h2 className="font-headline-lg text-headline-lg mb-4 text-on-primary font-bold">95% score improvement</h2>
                <p className="font-body-md text-body-md opacity-80 leading-relaxed">
                  Our specialized methodology ensures that nearly every student surpasses their initial diagnostic test results within 12 weeks.
                </p>
              </div>
            ...
            <div className="bg-white p-8 rounded-[2rem] card-shadow flex flex-col items-center justify-center text-center border border-outline-variant/20">
              ...
              <div className="font-headline-sm text-headline-sm text-primary font-bold">Global Placements</div>
              <p className="font-body-sm text-body-sm text-on-surface-variant mt-2 leading-relaxed">
                Accepted in Ivy League and Russell Group universities.
              </p>
            </div>
            ...
            <div className="bg-secondary-container p-8 rounded-[2rem] flex flex-col justify-between text-on-secondary-container shadow-sm border border-secondary/15">
              ...
              <div>
                <div className="font-headline-sm text-headline-sm text-on-secondary-container font-bold mb-1">58 Countries</div>
                <p className="font-body-sm text-body-sm text-on-secondary-container/80 leading-relaxed">
                  A global community of high achievers.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-margin-mobile text-left">
        <div className="max-w-container-max mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-headline-lg text-headline-lg text-primary font-bold mb-4">Voice of Excellence</h2>
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto">
              Real stories from real students who transformed their academic career with Dream Education.
            </p>
          </div>
        ...
        <div className="max-w-container-max mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="max-w-xl">
              <h2 className="font-headline-lg text-headline-lg mb-4 text-on-primary font-bold">The Proof is in the Progress</h2>
              <p className="font-body-lg text-body-lg opacity-80 leading-relaxed">
                Our students consistently achieve significant jumps in their band scores through rigorous practice and expert guidance.
              </p>
            </div>
            <Link
              to="/contact"
      ...
      <section className="py-24 px-margin-mobile text-center">
        <div className="max-w-4xl mx-auto bg-surface-container-highest p-8 md:p-12 rounded-[3rem] text-center relative overflow-hidden border border-outline-variant/30 shadow-sm">
          <div className="relative z-10 space-y-6">
            <h2 className="font-headline-lg text-headline-lg text-primary font-bold">Ready to be our next success story?</h2>
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-xl mx-auto leading-relaxed">
              Your journey to linguistic excellence starts with a single step. Take your free diagnostic test today.
            </p>
