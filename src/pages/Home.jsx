        ...
        <div className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-2 gap-stack-lg items-center w-full">
          <div className="space-y-stack-md text-left">
            <div className="inline-flex items-center gap-2 bg-secondary-container text-on-secondary-container px-4 py-1 rounded-full border border-secondary/20">
              ...
              <span className="font-label-md text-label-md uppercase tracking-wider">Cambridge Certified Partners</span>
            </div>
            <h1 className="font-headline-lg-mobile md:font-display-lg text-headline-lg-mobile md:text-display-lg text-primary leading-tight">
              Transform Your <span className="text-secondary">English.</span><br />Unlock Your Future.
            </h1>
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-lg">
              Expert IELTS preparation, academic English, and communication skills tailored for ambitious international learners seeking global opportunities.
            </p>
          ...
          <div className="hidden md:block relative">
            ...
            <div className="absolute bottom-10 -left-10 z-20 bg-surface p-6 rounded-xl shadow-2xl border border-outline-variant/30 flex items-center gap-4 animate-bounce-slow">
              ...
              <div className="text-left">
                ...
                <div className="font-label-md text-label-md text-on-surface-variant">Avg. IELTS Score</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            <div className="space-y-stack-sm p-6 bg-white rounded-xl shadow-sm border border-outline-variant/10">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                To bridge the gap between local potential and global opportunity through linguistic excellence and academic rigor.
              </p>
            ...
            <div className="space-y-stack-sm p-6 bg-white rounded-xl shadow-sm border border-outline-variant/10">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                Empowering students with the tools to master the English language, fostering confidence, and ensuring success in international education.
              </p>
              <div className="h-1 w-20 bg-secondary rounded-full"></div>
            </div>
            <div className="space-y-stack-sm p-6 bg-white rounded-xl shadow-sm border border-outline-variant/10">
              <h2 className="font-headline-md text-headline-md text-primary">Our Values</h2>
              <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                Integrity, Excellence, and Personalized Growth. We treat every student's journey as a unique path to global citizenship.
              </p>
              <div className="h-1 w-20 bg-secondary rounded-full"></div>
            </div>
          </div>
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="flex justify-between items-end mb-stack-lg">
            <div className="space-y-2">
              <span className="font-label-lg text-label-lg text-secondary uppercase tracking-widest font-bold">Our Curriculum</span>
              <h2 className="font-headline-lg text-headline-lg text-primary">Featured Programs</h2>
            </div>
            <Link
              to="/courses"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            ...
            <div className="group bg-surface rounded-xl overflow-hidden border border-outline-variant/30 card-shadow interactive-shadow transition-all duration-300">
              ...
              <div className="p-6 space-y-4">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant">
                  Build the core skills required for the IELTS exam. Focus on grammar, vocabulary, and basic test formats.
                </p>
                <div className="flex items-center gap-4 text-on-surface-variant">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-label-md">Max 12</span>
                  </div>
                </div>
                <Link
                  to="/courses"
            ...
            <div className="group bg-surface rounded-xl overflow-hidden border border-outline-variant/30 card-shadow interactive-shadow transition-all duration-300">
              ...
              <div className="p-6 space-y-4">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant">
                  A high-pressure boot camp for students aiming for immediate testing. Strategy-heavy curriculum.
                </p>
                <div className="flex items-center gap-4 text-on-surface-variant">
                  <div className="flex items-center gap-1">
                    <span className="material-symbols-outlined text-[18px]">schedule</span>
                  ...
                  <div className="flex items-center gap-1">
                    <span className="material-symbols-outlined text-[18px]">group</span>
                    <span className="text-label-md">Max 8</span>
                  </div>
                </div>
                <Link
                  to="/courses"
            ...
            <div className="group bg-surface rounded-xl overflow-hidden border border-outline-variant/30 card-shadow interactive-shadow transition-all duration-300">
              ...
              <div className="p-6 space-y-4">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant">
                  For students already at a band 6.5. Precise focus on the nuances required for top-tier scores.
                </p>
                <div className="flex items-center gap-4 text-on-surface-variant">
                  <div className="flex items-center gap-1">
                    <span className="material-symbols-outlined text-[18px]">schedule</span>
                  ...
                  <div className="flex items-center gap-1">
                    <span className="material-symbols-outlined text-[18px]">group</span>
                    <span className="text-label-md">Max 6</span>
                  </div>
                </div>
                <Link
                  to="/courses"
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-gutter text-center">
            <div className="space-y-2">
              ...
              <div className="font-label-lg text-label-lg uppercase opacity-80">Students Guided</div>
            </div>
            <div className="space-y-2">
              <div className="font-display-lg text-display-lg text-secondary-fixed font-bold">
                <AnimatedCounter target="98" suffix="%" />
              </div>
              <div className="font-label-lg text-label-lg uppercase opacity-80">Success Rate</div>
            </div>
            <div className="space-y-2">
              <div className="font-display-lg text-display-lg text-secondary-fixed font-bold">
                <AnimatedCounter target="150" />
              </div>
              <div className="font-label-lg text-label-lg uppercase opacity-80">Expert Tutors</div>
            </div>
            <div className="space-y-2">
              <div className="font-display-lg text-display-lg text-secondary-fixed font-bold">
                <AnimatedCounter target="12" />
              </div>
              <div className="font-label-lg text-label-lg uppercase opacity-80">Global Partners</div>
            </div>
          </div>
          ...
          <div className="mt-stack-lg bg-surface/5 backdrop-blur-md rounded-2xl p-8 border border-white/10 max-w-3xl mx-auto text-center">
            ...
            <p className="font-body-lg text-body-lg italic mb-6 leading-relaxed">
              "Dream Education didn't just teach me English; they gave me the confidence to apply for my PhD in London. My band score jumped from 6.0 to 8.0 in just 8 weeks."
            </p>
      ...
      <section className="py-stack-lg text-center">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="bg-surface-container-highest rounded-2xl p-8 md:p-12 space-y-6 border border-outline-variant/30 shadow-sm">
            <h2 className="font-headline-lg text-headline-lg text-primary">Ready to Start Your Journey?</h2>
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto">
              Take our free 15-minute diagnostic test to discover your current level and get a personalized learning roadmap.
            </p>
